    ...
    <form @submit.prevent="$emit('updateAccountInfo')">
        <div class="mb-3">
            ...
            <input
                ...
                :class="{ 'is-invalid': accountInfoForm.errors.name }"
                type="text"
            />
        ...
        <div class="mb-3">
            ...
            <input
                ...
                type="email"
                class="form-control form-control-sm"
                :class="{ 'is-invalid': accountInfoForm.errors.email }"
        ...
        <div class="mb-3">
            ...
            <select
                ...
                :class="{ 'is-invalid': accountInfoForm.errors.gender }"
                v-model="accountInfoForm.gender"
            >
                <option
                    v-for="(gender, index) in $page.props.genders"
                    :key="index"
                    :value="gender"
                >
                    {{ gender }}
        ...
        <div class="text-end">
            ...
            >
                ...
                <div
                    ...
                    role="status"
                    v-if="accountInfoForm.processing"
                >
...
defineEmits(["updateAccountInfo", "cancelRequest"]);
</script>
