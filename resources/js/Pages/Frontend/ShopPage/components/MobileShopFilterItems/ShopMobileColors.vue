<template>
    ...
    <div class="filter-item-wrap">
        <div class="filter-item">
            <button class="filter-item-name" type="button" id="filter-item-colors-btn" @click="openColorsOffcanvas">
        ...
        <div class="offcanvas offcanvas-end filter-item-offcanvas" id="filter-item-offcanvas-colors"
            ...
            <div class="offcanvas-body filter-item-offcanvas-body">
                <div class="list-group">
                    <label v-for="(color, index) in $page.props.colors" :key="index">
                        <div class="d-flex flex-row">
                            <img src="http://august.com/storage/images/colors/18-02-22-04-03-31-1645157011-black.png"
                                width="20" alt="Black" />
                            <span class="ms-2">{{ color.name }} ({{ color.products_count }})</span>
                        </div>

                        <div class="form-check-input-warp ">
                            <input class="form-check-input " type="checkbox" name="color[]" :id="'color-' + color.id"
                                :value="color.slug" v-model="filters.color" />
                        </div>
                    </label>
                </div>
            </div>
