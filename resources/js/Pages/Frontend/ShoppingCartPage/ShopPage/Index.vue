...
import ShopMobileView from '@/Pages/Frontend/ShopPage/views/Mobile/ShopMobileView.vue';
import ShopDesktopView from '@/Pages/Frontend/ShopPage/views/Desktop/ShopDesktopView.vue';
import { ref } from "vue";
