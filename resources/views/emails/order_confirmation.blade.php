...
<body
    style="width:100%;font-family:arial, 'helvetica neue', helvetica, sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;Margin:0">
    <div class="es-wrapper-color" style="background-color:#F9F7F7">

        <table class="es-wrapper" width="100%" cellspacing="0" cellpadding="0"
            style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;padding:0;Margin:0;width:100%;height:100%;background-repeat:repeat;background-position:center top;background-color:#F9F7F7">
                                ...
                                <table class="es-header-body"
                                    ...
                                    <tr style="border-collapse:collapse">
                                        <td align="center" bgcolor="#efefef"
                                            style="Margin:0;padding-top:5px;padding-bottom:5px;padding-left:15px;padding-right:15px;background-color:#efefef">
                                                        ...
                                                        <table
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    ...
                                                                    <h4 style="color: black">Hi
                                                                        {{ $user['name'] }}</h4>
                                                                    <span
                                                                        style="color: black; background-color: rgb(238, 238, 238)">
                                                                        We like your style! Thanks for shopping with us.
                                                                    </span>
                                                                    <br>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        style="text-align: center;Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                        Here's a confirmation of your order and all the
                                                                        details you may need. We might contact you for
                                                                        verification so please keep a tab on your phone.
                        ...
                        <tr style="border-collapse:collapse">
                            <td align="center" style="padding:0;Margin:0">
                                <table class="es-content-body" cellspacing="0" cellpadding="0" bgcolor="#ffffff"
                                    ...
                                    <tr style="border-collapse:collapse">
                                        <td align="center"
                                            style="Margin:0;padding-top:5px;padding-left:10px;padding-right:10px;">
                                            ...
                                            <table class="es-left" cellspacing="0" cellpadding="0" align="center"
                                                ...
                                                <tr style="border-collapse:collapse">
                                                    <td class="es-m-p20b" align="center"
                                                        ...
                                                        <table
                                                            style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px;background-color:#f9f7f7;border-color:#efefef;border-width:1px 0px 1px 1px;border-style:solid"
                                                            width="100%" cellspacing="0" cellpadding="0"
                                                            bgcolor="#f9f7f7" role="presentation">
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    ...
                                                                    <table
                                                                        ...
                                                                        <tr style="border-collapse:collapse">
                                                                            <td style="padding:0;Margin:0"><span
                                                                                    style="font-size:14px;line-height:21px">Name:
                                                                                    {{ $user['name'] }}
                                                                                </span></td>
                                                                        ...
                                                                        <tr style="border-collapse:collapse">
                                                                            <td style="padding:0;Margin:0"><span
                                                                                    style="font-size:14px;line-height:21px">Email:
                                                                                    {{ $user['email'] }}</span>
                                                                            </td>
                                                                    ...
                                                                    <table
                                                                        ...
                                                                        <tr style="border-collapse:collapse">
                                                                            <td style="padding:0;Margin:0"><span
                                                                                    ...
                                                                                    Date:</span></td>
                                                                            <td style="padding:0;Margin:0"><span
                                                                                    style="font-size:14px;line-height:21px">{{ $order->created_at->format('M d, Y  h:i A') }}</span>
                                                                            </td>
                                                                        </tr>
                                                                        <tr style="border-collapse:collapse">
                                                                            <td style="padding:0;Margin:0"><span
                                                                        ...
                                                                        <tr style="border-collapse:collapse">
                                                                            <td style="padding:0;Margin:0"><span
                                                                                    style="font-size:14px;line-height:21px">Shipping:</span>
                                                                            </td>
                                                                            <td style="padding:0;Margin:0"><span
                                                                                    style="font-size:14px;line-height:21px">{{ $order->shipping_fees == 0 ? 'Free' : $order->shipping_fees . ' SAR' }}</span>
                                                                            </td>
                                                                        </tr>
                                                                        <tr style="border-collapse:collapse">
                                                                            <td style="padding:0;Margin:0"><span
                                                                                    ...
                                                                                    Total:</span></td>
                                                                            <td style="padding:0;Margin:0"><span
                                                                                    style="font-size:14px;line-height:21px">{{ $order->total }}
                                                                                    SAR</span>
                                                                            </td>
                                                                        </tr>
                                                                ...
                                                                <td align="left"
                                                                    ...
                                                                    <table
                                                                        ...
                                                                        <tr style="border-collapse:collapse">
                                                                            <td style="padding:0;Margin:0">
                                                                                <span
                                                                                    style="font-size:14px;line-height:21px">{{ $shippingAddress->full_name }}</span>
                                                                            </td>
                                                                        ...
                                                                        <tr style="border-collapse:collapse">
                                                                            <td style="padding:0;Margin:0">
                                                                                <span
                                                                                    style="font-size:14px;line-height:21px ">{{ $shippingAddress->address }}</span>
                                                                            </td>
                                                                        ...
                                                                        <tr style="border-collapse:collapse">
                                                                            <td style="padding:0;Margin:0">
                                                                                ...
                                                                                <span
                                                                                    style="font-size:14px;line-height:21px">{{ $shippingAddress->city }}
                                                                                    ,
                                                                        ...
                                                                        <tr style="border-collapse:collapse">
                                                                            <td style="padding:0;Margin:0">
                                                                                ...
                                                                                <span
                                                                                    style="font-size:14px;line-height:21px">{{ $shippingAddress->phone_number }}
                                                                                </span>
                                                                            </td>
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    ...
                                                                    <h5
                                                                        style="Margin:0;line-height:120%;mso-line-height-rule:exactly;font-family:'trebuchet ms', helvetica, sans-serif">
                                                                        THIS IS THE STUFF YOU'VE PICKED</h5>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-c" align="center"
                                                                    ...
                                                                    <p>
                                                                        ...
                                                                        your wardrobe will thank you too .
                                                                    </p>
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                        Lucky you! We'll be shipping out your order
                                                                        items in multiple shipments so that they get to
