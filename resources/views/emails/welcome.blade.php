            ...
            <td align="center">
                <table border="0" align="center" width="590" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('homePage') }}">
                                <img src="{{ asset('assets/images/welcome-club.jpg') }}" class="w-100"
                                    alt="" />
                            </a>
                        </td>
                    </tr>
                                ...
                                <tr>
                                    <td align="center"
                                        ...
                                        <div style="line-height: 26px;">
                                            <a href="{{ route('homePage') }}"
                                                style="color: #ffffff; text-decoration: none;">HAPPY SHOPPING !</a>
                                        </div>
                                    </td>
                                </tr>
                        ...
                        <td>
                            <table border="0" width="300" align="left" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <!-- logo -->
                                    <td align="left">
                                        <h2> <a href="{{ route('homePage') }}" style="text-decoration: none">
                                                {{ config('app.name') }}
