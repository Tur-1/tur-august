...
Route::get('/wishlist', [WishlistPageController::class, 'index'])->middleware('auth')->name('wishlistPage');

Route::post('/add-to-wishlist', [WishlistPageController::class, 'addToWishlist'])->middleware('auth')->name('addToWishlist');

Route::get('/cart', [ShoppingCartPageController::class, 'index'])->middleware('auth')->name('shoppingCartPage');

Route::post('/add-to-cart', [ShoppingCartPageController::class, 'addToShoppingCart'])->middleware('auth')->name('addToShoppingCart');

Route::get('/checkout', [CheckoutPageController::class, 'index'])->middleware('auth')->name('checkoutPage');
